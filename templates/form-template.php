...
<div class="wp-crowdfundtime-form-container">
    ...
    <form class="wp-crowdfundtime-form" method="post" action="">
        ...
        <div class="form-field">
            <label for="hours"><?php echo esc_html__('Stunden', 'wp-crowdfundtime'); ?> *</label>
            <input type="number" name="hours" id="hours" min="1" value="1" required>
        </div>
        
        <div class="form-field">
            <button type="submit" name="wp_crowdfundtime_submit" class="submit-button"><?php echo esc_html__('Zeit spenden', 'wp-crowdfundtime'); ?></button>
        </div>
    </form>
